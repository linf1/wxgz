...
import com.base.util.ybwithUtil;

import java.security.MessageDigest;
import java.util.Arrays;

public class YbWithdrawsApi {
    ...
    public static String signMD5(String aValue,String encoding){
        try {
            ...
            return ybwithUtil.toHex(md.digest(input));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String digest(String aValue,String encoding)
    {
        ...
        return ybwithUtil.toHex(md.digest(value));
    }
    ...
    public static String udpSign(String aValue){
        try {
            ...
            return new String(ybBase64.encode(md.digest(input)), ENCODE);
        } catch (Exception e) {
            return null;
        }
    }
